        ...
        <div class="flip-card-inner">
            ...
            <div class="flip-card-back1">
              <h1>Renta de cancha</h1>
               Solicita el espacio de la cancha "Madriguera" para eventos y partidos.
...
<section class="esta">
    <p class="fw-bolder fs-4 text-center mt-3"> Selecciona la liga </p>
    ...
    <div class="container text-center my-5 goalscorer-table" style="width: 100%">
        <!-- Tabla de goleo  -->
        <div class="container text-center mt-5" style="justify-content: center; width: 300%">
            <div class="row justify-content-center mx-1" style="width: 100%">
    ...
    <div class="container text-center my-5 position-table" style="justify-content: center;">
        <div class="card">
            <div class="card-body">
                <h2 class="card-title fw-bolder mb-4"> Tabla de posición </h2>
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-dark text-light table-bordered align-middle" style="justify-content: center;">
                        <thead>
                            <tr>
                                <th>Posición</th>
                                <th>Equipo</th>
